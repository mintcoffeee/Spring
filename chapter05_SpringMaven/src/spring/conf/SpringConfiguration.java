...
// = <tx:annotation-driven transaction-manager="transactionManager"/> , applicationContext.xml와 같은거 둘중 하나만 사용 
public class SpringConfiguration {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception{
		...
		// ClassPathResource: Resource 를 제공한다, 단점: 한개만 줄 수 있다. 여러개 불가 
